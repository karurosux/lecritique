...
import (
	...
	"github.com/lecritique/api/internal/server/routes"
	"github.com/lecritique/api/shared/config"
	"github.com/lecritique/api/shared/logger"
...
func New(cfg *config.Config, db *gorm.DB) *Server {
	...
	// Setup routes (temporarily keep original while domains are being refined)
