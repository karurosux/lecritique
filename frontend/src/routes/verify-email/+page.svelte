      ...
      {#if verifying}
        ...
        <div class="mb-8">
          <div class="relative inline-flex">
            ...
            <div class="relative bg-gradient-to-br from-blue-400 to-blue-600 p-6 rounded-full">
      ...
      {:else}
        ...
        <div class="mb-8">
          <div class="relative inline-flex">
            ...
            <div class="relative bg-gradient-to-br from-red-400 to-red-600 p-6 rounded-full">
