...
<svelte:head>
  ...
  <meta
    name="description"
    content="Please verify your email address to access Kyooar" />
</svelte:head>
    ...
    <div class="text-center">
      ...
      <div class="mb-8 alert-icon-container" class:show={showContent}>
        <div class="relative inline-flex">
          <div
            class="absolute inset-0 bg-orange-500/20 rounded-full blur-xl animate-pulse">
          </div>
          <div
            class="relative bg-gradient-to-br from-orange-400 to-orange-600 p-6 rounded-full">
      ...
      <div class="space-y-6 content-container" class:show={showContent}>
        ...
        <div
          class="bg-orange-50 border border-orange-200 rounded-lg p-6 text-left">
          <div class="flex gap-4">
            ...
            <div class="space-y-2">
              ...
              <p class="text-sm text-gray-700">
                We've sent a verification email to <strong class="font-medium"
                  >{email}</strong>
              </p>
