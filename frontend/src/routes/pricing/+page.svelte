...
<svelte:head>
  ...
  <meta
    name="description"
    content="Select the perfect Kyooar plan for your organization feedback needs." />
</svelte:head>

<div class="min-h-screen relative bg-gray-50">
  <!-- Light gradient background -->
  <div
    class="fixed inset-0 bg-gradient-to-br from-blue-50 via-white to-purple-50">
  </div>

  <!-- Animated gradient orbs with light colors -->
  <div class="fixed inset-0 overflow-hidden">
    <div
      class="absolute -top-[40%] -left-[20%] w-[60%] h-[60%] bg-gradient-to-br from-purple-400 to-pink-400 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse">
    </div>
    <div
      class="absolute -bottom-[40%] -right-[20%] w-[60%] h-[60%] bg-gradient-to-br from-blue-400 to-cyan-400 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse animation-delay-2000">
    </div>
    <div
      class="absolute top-[20%] right-[30%] w-[40%] h-[40%] bg-gradient-to-br from-indigo-400 to-purple-400 rounded-full mix-blend-multiply filter blur-3xl opacity-8 animate-pulse animation-delay-4000">
    </div>
  </div>
  ...
  <div class="relative z-10">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
      ...
      <div class="text-center mb-16">
        <h1
          class="text-5xl sm:text-6xl font-bold text-gray-900 mb-4 tracking-tight">
          Choose Your
          <span
            class="block text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600">
            Perfect Plan
          </span>
        </h1>
      ...
      {#if isLoading}
        <div class="flex justify-center items-center py-24">
          <div
            class="animate-spin rounded-full h-12 w-12 border-4 border-purple-600 border-t-transparent">
          </div>
        </div>
      {:else if plans.length > 0}
        <div class="relative">
          ...
          <div
            class="absolute inset-0 bg-gradient-to-r from-purple-300/20 via-blue-300/20 to-purple-300/20 blur-3xl">
          </div>
          <div class="relative">
            <PlanSelector
              {plans}
        ...
        <div class="mt-20 text-center">
          <Card
            variant="glass"
            class="inline-flex items-center justify-center space-x-8 flex-wrap gap-y-4 px-8 py-6">
        ...
        <Card variant="glass" class="mt-16 max-w-2xl mx-auto">
          <div class="text-center">
            <div
              class="inline-flex items-center justify-center w-14 h-14 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl mb-4 shadow-lg">
