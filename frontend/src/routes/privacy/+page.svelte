...
<div class="min-h-screen bg-gradient-to-b from-white to-gray-50/50">
  <!-- Floating Header -->
  <div class="privacy-header fixed top-0 left-0 right-0 z-40 bg-white/80 backdrop-blur-xl border-b border-gray-100 transition-all duration-300" class:shadow-lg={scrollY > 50}>
