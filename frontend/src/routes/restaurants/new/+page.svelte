<script lang="ts">
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      const response = await api.api.v1RestaurantsCreate({
        name: formData.name,
...
<svelte:head>
  <title>Add Restaurant - LeCritique</title>
  ...
  <div class="bg-white shadow-sm border-b">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center py-6">
        <div>
          <h1 class="text-2xl font-bold text-gray-900">Add Restaurant</h1>
          <p class="text-gray-600">Create a new restaurant profile</p>
        </div>
