...
<div class="analytics-grouped-demo max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
  ...
  <div class="mb-8">
    <div
      ...
      <div class="flex items-center space-x-3">
        <Button variant="outline" href="/analytics" class="group">
          Back to Original
        </Button>
        <Button
          variant="gradient"
  ...
  <div class="mb-8">
    <Card variant="elevated">
      <div
        ...
        <div class="flex items-center space-x-4">
          <div
            class="h-10 w-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center">
        ...
        <div class="flex items-center space-x-4">
          <div
            class="h-10 w-10 bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl flex items-center justify-center">
  ...
  <div class="mb-8">
    <Card
      ...
      <div class="flex items-start gap-3">
        ...
        <div>
          <h3 class="text-lg font-semibold text-purple-900 mb-1">
            New Grouped View
          </h3>
