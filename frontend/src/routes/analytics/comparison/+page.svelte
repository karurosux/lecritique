<script lang="ts">
  ...
  let viewMode = $state<'side-by-side' | 'original' | 'grouped'>(
    'side-by-side'
  );
...
<div
  class="analytics-comparison max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
  <!-- Header -->
  <div class="mb-8">
    <div
        ...
        <div class="flex items-center space-x-3">
          ...
          <div>
            ...
            <p class="text-gray-600 font-medium">
              Compare original and grouped chart views
            </p>
          </div>
        </div>
      </div>
    ...
    <Card variant="elevated">
      <div
        ...
        <div class="flex items-center space-x-4">
          <div
            class="h-10 w-10 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center">
          ...
          <div>
            ...
            {#if chartData?.summary?.total_responses}
              <p class="text-sm text-gray-500 mt-1">
                {chartData.summary.total_responses} total responses
              </p>
            {/if}
          </div>
        </div>
  ...
  {:else if error}
    ...
    <Card variant="elevated">
      <div class="text-center py-12">
        <div
          class="h-16 w-16 bg-red-100 rounded-2xl flex items-center justify-center mx-auto mb-4">
          <svg
  ...
  {:else}
    ...
    {#if viewMode === 'side-by-side'}
      <div class="grid grid-cols-1 xl:grid-cols-2 gap-8">
        ...
        <div>
          <Card
            variant="gradient"
            class="mb-4 bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
            <div class="flex items-center gap-3">
              <div
                class="h-8 w-8 bg-white rounded-lg flex items-center justify-center shadow-sm">
              ...
              <div>
                ...
                <p class="text-sm text-blue-700">
                  All charts in a flat grid layout
                </p>
              </div>
            </div>
          </Card>
          <ChartDataWidget {chartData} title="" />
        </div>
        ...
        <div>
          <Card
            variant="gradient"
            class="mb-4 bg-gradient-to-r from-purple-50 to-pink-50 border-purple-200">
            <div class="flex items-center gap-3">
              <div
                class="h-8 w-8 bg-white rounded-lg flex items-center justify-center shadow-sm">
              ...
              <div>
                ...
                <p class="text-sm text-purple-700">
                  Charts grouped by product with collapsible sections
                </p>
              </div>
            </div>
          </Card>
    ...
    {:else if viewMode === 'original'}
      <ChartDataWidget {chartData} title="Original Analytics View" />
    {:else}
      <ChartDataWidgetGrouped
        {chartData}
        title="Grouped Analytics View"
        groupByProduct={true}
        initiallyExpanded={false} />
    {/if}
  {/if}
