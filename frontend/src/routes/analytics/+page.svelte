    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center py-6">
        <div>
          ...
          <p class="text-gray-600">Detailed insights and performance metrics for your restaurants.</p>
        </div>
        <div class="flex space-x-3">
          ...
          <Button variant="outline" on:click={exportReport} disabled={!analyticsData}>
