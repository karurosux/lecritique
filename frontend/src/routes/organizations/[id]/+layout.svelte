<script lang="ts">
  ...
  import { ArrowLeft, Store, Package, QrCode } from 'lucide-svelte';
  ...
  const navItems = [
    ...
    {
      href: `/organizations/${organizationId}/qr-codes`,
      label: 'QR Codes',
      icon: QrCode,
    },
  ];
  ...
  <div class="relative pt-4 pb-2">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex items-center justify-between mb-3">
        <div class="flex items-center gap-4">
          ...
          <div class="flex items-center gap-3">
            <div
              class="h-10 w-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/25">
      ...
      <div class="flex justify-center mb-4">
        <div
          class="bg-white backdrop-blur-sm rounded-xl shadow-lg shadow-gray-900/10 border border-gray-200/50 p-1">
