    ...
    <div class="grid grid-cols-1 gap-3 text-sm text-gray-600">
      ...
      {#if restaurant.website}
        <div class="flex items-center space-x-2">
          ...
          <a href={restaurant.website} target="_blank" rel="noopener noreferrer" class="text-blue-600 hover:text-blue-800 truncate">
            {restaurant.website}
          </a>
        </div>
      {/if}
      ...
      <div class="flex items-center space-x-4 flex-1 min-w-0">
        ...
        <div class="flex-1 min-w-0 grid grid-cols-1 md:grid-cols-4 gap-4">
          <div class="min-w-0">
            ...
            <div class="flex items-center space-x-2 mt-1">
              <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium {getStatusColor(restaurant.status)}">
                {restaurant.status}
              </span>
              {#if restaurant.cuisine_type}
          ...
          <div class="min-w-0">
            ...
            {/if}
            {#if restaurant.website}
              <a href={restaurant.website} target="_blank" rel="noopener noreferrer" class="text-sm text-blue-600 hover:text-blue-800 truncate block mt-1">
                {restaurant.website}
              </a>
            {/if}
          </div>
