...
<div class="mb-8">
  <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-6">
    ...
    <div class="flex items-center space-x-3">
      <!-- View Mode Toggle -->
      <div class="flex items-center bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl border border-gray-200 p-1 shadow-lg">
        <button
          class="p-2 rounded-lg transition-all duration-200 cursor-pointer {viewMode === 'grid' ? 'bg-blue-100 text-blue-600' : 'text-gray-500 hover:text-gray-700'}"
        ...
        <button
          class="p-2 rounded-lg transition-all duration-200 cursor-pointer {viewMode === 'list' ? 'bg-blue-100 text-blue-600' : 'text-gray-500 hover:text-gray-700'}"
