  ...
  <Card
    ...
    <div class="flex items-center space-x-4 mb-4">
      ...
      <div class="space-y-1 flex-1">
        ...
        <p
          class="text-xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent truncate max-w-[200px]"
      ...
      {#if organization.website}
        <div class="flex items-center space-x-3">
          ...
          <a
            ...
            class="text-sm text-blue-600 hover:text-blue-800 truncate font-medium transition-colors">
      ...
      <div class="flex items-center space-x-4 flex-1 min-w-0">
        ...
        <div
          ...
          <div class="min-w-0">
            ...
            <h3
              class="font-bold text-gray-900 truncate max-w-[160px]"
              title={organization.name}>
              {organization.name}
            </h3>
          ...
          <div class="min-w-0 space-y-1">
            {#if organization.email}
              <div class="flex items-center space-x-2">
                <div
                  class="h-5 w-5 bg-blue-100 rounded flex items-center justify-center">
            ...
            {#if organization.phone}
              <div class="flex items-center space-x-2">
                <div
                  class="h-5 w-5 bg-green-100 rounded flex items-center justify-center">
          ...
          <div class="min-w-0 space-y-1">
            ...
            {#if organization.website}
              <div class="flex items-center space-x-2">
                <div
                  class="h-5 w-5 bg-purple-100 rounded flex items-center justify-center">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  class="text-xs text-blue-600 hover:text-blue-800 truncate font-medium transition-colors">
                  {organization.website}
                </a>
              </div>
            {/if}
