<script lang="ts">
  ...
  async function generateAIQuestions() {
    try {
      ...
      const generatedQuestions = await QuestionApi.generateQuestions(
        organizationId,
        productId
      );
      ...
      <div
        ...
        <div class="relative mb-6">
          ...
          <div class="absolute inset-0 w-20 h-20 mx-auto">
            <div
              class="w-full h-full border-4 border-purple-200 rounded-full animate-spin border-t-purple-500">
            </div>
          </div>
        </div>
        ...
        <div class="space-y-3">
          {#each questions as question, index}
            <div
              ...
              <div
                class="cursor-move"
                class:opacity-50={loading || generatingQuestions || reordering}>
