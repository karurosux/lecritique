  ...
  <div class="space-y-4">
    ...
    <div class="grid grid-cols-3 gap-3 mb-6">
      <div
        ...
        <div class="text-xs font-bold text-green-600 uppercase tracking-wide">
          Loved It
        </div>
      </div>
      <div
        ...
        <div class="text-xs font-bold text-amber-600 uppercase tracking-wide">
          It's OK
        </div>
      </div>
      <div
