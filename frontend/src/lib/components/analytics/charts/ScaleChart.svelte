        ...
        plugins: {
          ...
          tooltip: {
            callbacks: {
              ...
              label: (context: any) =>
                `${context.dataset.label}: ${formatScaleValue(context.parsed.y)}`,
            },
          },
        },
        scales: {
            ...
            <div class="space-y-2 text-sm">
              <div class="flex justify-between">
                ...
                <span class="font-semibold"
                  >{formatScaleValue(seriesData.statistics.average)}</span>
              </div>
              <div class="flex justify-between">
                <span class="text-gray-600">Highest:</span>
                <span class="font-semibold"
                  >{formatScaleValue(seriesData.statistics.max)}</span>
              </div>
              <div class="flex justify-between">
                <span class="text-gray-600">Lowest:</span>
                <span class="font-semibold"
                  >{formatScaleValue(seriesData.statistics.min)}</span>
              </div>
