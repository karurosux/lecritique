...
export const termsContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      content: `By accessing or using LeCritique, you agree to be bound by these Terms. If you do not agree to these Terms, please do not use our services.`
    },
    {
    ...
    },
    {
      ...
      content: `To use LeCritique, you must create an account. You agree to provide accurate, current, and complete information during registration and to update such information to keep it accurate, current, and complete.`
    },
    {
      title: '4. Subscription and Payment',
      content: `LeCritique offers various subscription tiers (Starter, Professional, Enterprise). Payment terms, refund policies, and subscription limits are detailed in your subscription agreement. All payments are processed through Stripe.`
    },
    {
    ...
    },
    {
      ...
      content: `You agree not to use LeCritique for any illegal or unauthorized purpose. You must not violate any laws in your jurisdiction, including but not limited to copyright laws.`
    },
    {
    ...
    },
    {
      ...
      content: `LeCritique and its original content, features, and functionality are owned by LeCritique and are protected by international copyright, trademark, patent, trade secret, and other intellectual property laws.`
    },
    {
    ...
    },
    {
      ...
      content: `To the maximum extent permitted by law, LeCritique shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use or inability to use the service.`
    },
    {
...
These terms and conditions may change at the discretion of LeCritique. We encourage you to review these terms periodically for any updates.`
    },
    {
    ...
    },
    {
      ...
      content: `These Terms shall be governed and construed in accordance with the laws of the jurisdiction in which LeCritique operates, without regard to its conflict of law provisions.`
    },
    {
