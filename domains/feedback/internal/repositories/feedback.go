...
type FeedbackRepository interface {
	...
	FindByRestaurantID(restaurantID uuid.UUID, req PageRequest) (*PageResponse[models.Feedback], error)
	FindByDishID(dishID uuid.UUID, req PageRequest) (*PageResponse[models.Feedback], error)
...
func NewFeedbackRepository(db *gorm.DB) FeedbackRepository {
	return &feedbackRepository{
		BaseRepository: NewBaseRepository[models.Feedback](db),
	}
}
