...
(
    ...
    'Professional',
    'professional',
    'For growing organizations with multiple locations',
    79.00,
    'USD',
    'month',
    '{
...
(
    ...
    'Premium',
    'premium',
    'For organization chains and large operations',
    199.00,
    'USD',
    'month',
    '{
...
('Food', 'Food Temperature', 'Temperature of the product', 'Was your food served at the right temperature?', 'single_choice', '{"Too cold", "Just right", "Too hot"}', NULL, NULL, '{"food", "temperature"}'),
...
('Food', 'Taste Rating', 'Taste satisfaction', 'How would you rate the taste of your product?', 'rating', NULL, 1, 5, '{"food", "taste"}'),
('Food', 'Presentation', 'Food presentation rating', 'How would you rate the presentation of your product?', 'rating', NULL, 1, 5, '{"food", "presentation"}'),
('Ambiance', 'Cleanliness', 'Organization cleanliness', 'How clean was the organization?', 'scale', NULL, 1, 10, '{"ambiance", "cleanliness"}'),
